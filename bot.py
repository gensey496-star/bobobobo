...
# ⚙ НАСТРОЙКИ
# ======================
# ВАЖНО: токен нельзя хардкодить в коде. Укажи в переменных окружения на сервере:
# BOT_TOKEN=.... (например в apply.build)
...
NO_CLASSES_PHRASES = [
    ...
    "Время есть иди готовь две в сырном",
    "Сіз қаншықсыз очпочмак сізге жете алмайсыз",
    "Мама разрешила не идти",
    "Иди домой, пары закончились",
    "На сегодня всё, отдыхай",
    "Пар нет, наслаждайся жизнью",
    "Пар нет, а Скитейкин лох",
    "А сам чекнуть не можешь?",
    "Заходят как то два дракона в бар. Один спрашивает другого: Почему здесь так жарко? -Ебало завали.",
    "Не скажу",
    "У Вики спроси",
    "Напиши я гей, а я скину тебе сто рублей",
    "Извените а кто ваш любимый исполнитель?",
    "Я не ебу",
    ...
    "even": {
        "Monday": [
            ...
            },
            {
                "start": time(13, 20),
                "end": time(14, 50),
                "name": "ПЗ Математическая логика и теория алгоритмов",
                "room": "309А",
                "teacher": "ст.пр. Степанова Е.И.",
            },
            {
                "start": time(15, 0),
                "end": time(16, 30),
                "name": "ЛК Человек и право",
                "room": "309А",
        ...
        "Tuesday": [
            {
                "start": time(9, 50),
                "end": time(11, 20),
                "name": "ЛК Цифровые технологии в профессиональной сфере",
                "room": "309А",
            ...
            },
            {
                "start": time(11, 30),
                "end": time(13, 0),
                "name": "ПЗ Цифровые технологии в профессиональной сфере",
                "room": "8А",
                "teacher": "доц. Филиппов Д.М.",
            },
            {
        ...
        "Wednesday": [
            {
                "start": time(9, 50),
                "end": time(11, 20),
                "name": "1 подгруппа - нет пары | 2 подгруппа - ПЗ Теория и технологии программирования",
                "room": "119А",
                "teacher": "Енина А.А.",
            },
            {
                "start": time(11, 30),
                "end": time(13, 0),
                "name": "ЛК Теория и технологии программирования",
                "room": "18А",
        ...
        "Thursday": [
            ...
            },
            {
                "start": time(9, 50),
                "end": time(11, 20),
                "name": "ПЗ Основы российской государственности",
                "room": "411В",
                "teacher": "Валуев Д.Г.",
            },
            {
                "start": time(11, 30),
                "end": time(13, 0),
                "name": "ЛК Экономическая культура и финансовая грамотность",
                "room": "411В",
                "teacher": "Друзин Р.В.",
            },
            {
                "start": time(13, 20),
                "end": time(14, 50),
                "name": "ПЗ Экономическая культура и финансовая грамотность",
                "room": "411В",
                "teacher": "Друзин Р.В.",
            },
        ],
        "Friday": [
            {
                "start": time(8, 0),
                "end": time(9, 30),
                "name": "1 подгруппа - ПЗ Теория и технологии программирования | 2 подгруппа - нет пары",
                "room": "119А",
                "teacher": "Енина А.А.",
            },
            {
                "start": time(9, 50),
                "end": time(11, 20),
                "name": "ЛК Математическая логика и теория алгоритмов",
                "room": "302В",
            ...
            },
            {
                "start": time(11, 30),
                "end": time(13, 0),
                "name": "ЛК Метрология, стандартизация и сертификация",
                "room": "301В",
                "teacher": "куратор группы Дементьев М.Ю.",
            },
            {
                "start": time(13, 20),
                "end": time(14, 50),
                "name": "ПЗ Метрология, стандартизация и сертификация",
                "room": "301В",
                "teacher": "куратор группы Дементьев М.Ю.",
            },
        ],
    ...
    "odd": {
        ...
        "Wednesday": [
            ...
            },
            {
                "start": time(11, 30),
                "end": time(13, 0),
                "name": "ЛК Основы российской государственности",
                "room": "309В",
                "teacher": "Валуев Д.Г.",
            },
            {
        ...
        "Friday": [
            ...
            },
            {
                "start": time(13, 20),
                "end": time(14, 50),
                "name": "ЛК Материаловедение",
                "room": "ул.Генерала Васильева,32а (завод СЭЛМА)",
                "teacher": "Скиданчук А.Г.",
            },
            {
                "start": time(15, 0),
                "end": time(16, 30),
                "name": "ПЗ Материаловедение",
                "room": "ул.Генерала Васильева,32а (завод СЭЛМА)",
                "teacher": "Скиданчук А.Г.",
            },
        ],
...
# user context for "schedule on any day"
...
def get_safe_keyboard(user_id: int, chat_type: str) -> ReplyKeyboardMarkup:
    ...
    buttons = [
        ...
        [KeyboardButton(text="🗓️ Расписание на любой день")],  # <-- NEW
...
def get_user_week_select_keyboard():
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(text="Чётная неделя", callback_data="usr_week_even"),
                InlineKeyboardButton(text="Нечётная неделя", callback_data="usr_week_odd"),
            ],
...
def get_user_days_keyboard():
    ...
    for i in range(0, len(days), 2):
        row = [InlineKeyboardButton(text=days[i][1], callback_data=f"usr_day_{days[i][0]}")]
        if i + 1 < len(days):
            row.append(InlineKeyboardButton(text=days[i + 1][1], callback_data=f"usr_day_{days[i + 1][0]}"))
        keyboard.append(row)
    keyboard.append([InlineKeyboardButton(text="🔙 Назад", callback_data="usr_nav_week")])
...
def get_lesson_edit_keyboard(week_type, day_name, idx):
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [InlineKeyboardButton(text="🆕 Изменить пару полностью", callback_data=f"edit_full_{week_type}_{day_name}_{idx}")],
            [InlineKeyboardButton(text="🗑️ Удалить пару (на этот день)", callback_data=f"del_{week_type}_{day_name}_{idx}")],
...
async def today_schedule(message: Message):
    ...
    for i, lesson in enumerate(lessons_sorted):
        ...
        if i < len(lessons_sorted) - 1:
            ...
            gap_seconds = (
                datetime.combine(today, next_lesson["start"]) - datetime.combine(today, lesson["end"])
            ).total_seconds()
...
async def tomorrow_schedule(message: Message):
    ...
    for i, lesson in enumerate(lessons_sorted):
        ...
        if i < len(lessons_sorted) - 1:
            next_lesson = lessons_sorted[i + 1]
            gap_seconds = (
                datetime.combine(tomorrow, next_lesson["start"]) - datetime.combine(tomorrow, lesson["end"])
            ).total_seconds()
            gap_minutes = int(gap_seconds // 60)
...
@dp.message(F.text == "🗓️ Расписание на любой день")  # <-- NEW
async def schedule_any_day_entry(message: Message):
    if not is_allowed_thread(message):
        await message.answer("❌ Эта команда доступна только в разрешённой ветке")
        return

    await message.answer("Выберите тип недели:", reply_markup=get_user_week_select_keyboard())


@dp.callback_query(F.data == "usr_week_even")  # <-- NEW
async def usr_choose_week_even(callback: CallbackQuery):
    if not is_allowed_thread(callback.message):
        await callback.answer("❌ Недоступно в этой ветке", show_alert=True)
        return
    user_schedule_context[callback.from_user.id] = {"week_type": "even"}
    await callback.message.edit_text("Выберите день недели:", reply_markup=get_user_days_keyboard())
    await callback.answer()


@dp.callback_query(F.data == "usr_week_odd")  # <-- NEW
async def usr_choose_week_odd(callback: CallbackQuery):
    if not is_allowed_thread(callback.message):
        await callback.answer("❌ Недоступно в этой ветке", show_alert=True)
        return
    user_schedule_context[callback.from_user.id] = {"week_type": "odd"}
    await callback.message.edit_text("Выберите день недели:", reply_markup=get_user_days_keyboard())
    await callback.answer()


@dp.callback_query(F.data == "usr_nav_week")  # <-- NEW
async def usr_back_to_week(callback: CallbackQuery):
    if not is_allowed_thread(callback.message):
        await callback.answer("❌ Недоступно в этой ветке", show_alert=True)
        return
    await callback.message.edit_text("Выберите тип недели:", reply_markup=get_user_week_select_keyboard())
    await callback.answer()


def format_lessons_for_day(week_type: str, day_en: str) -> str:
    ...
    if not lessons_sorted:
        return f"<b>📅 {day_ru}</b> ({week_str} неделя)\n\nПар на этот день нет."

    dummy_date = date(2000, 1, 1)

    text = f"<b>📅 {day_ru}</b> ({week_str} неделя)\n\n"
    for i, lesson in enumerate(lessons_sorted):
        text += (
        ...
        if i < len(lessons_sorted) - 1:
            next_lesson = lessons_sorted[i + 1]
            gap_seconds = (
                datetime.combine(dummy_date, next_lesson["start"]) - datetime.combine(dummy_date, lesson["end"])
            ).total_seconds()
            gap_minutes = int(gap_seconds // 60)
            if gap_minutes > 30:
                text += f"⏸️ <b>Окно: {gap_minutes} мин</b>\n\n"
...
@dp.callback_query(F.data.startswith("usr_day_"))  # <-- NEW
async def usr_show_selected_day(callback: CallbackQuery):
    if not is_allowed_thread(callback.message):
        await callback.answer("❌ Недоступно в этой ветке", show_alert=True)
        return

    day_en = callback.data.replace("usr_day_", "")
    ctx = user_schedule_context.get(callback.from_user.id, {})
    week_type = ctx.get("week_type")

    if not week_type:
        await callback.answer("Сначала выбери чёт/нечёт", show_alert=True)
        return

    text = format_lessons_for_day(week_type, day_en)
    ...
    await callback.message.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            inline_keyboard=[
                [InlineKeyboardButton(text="🔙 К выбору недели", callback_data="usr_nav_week")],
                [InlineKeyboardButton(text="🔙 В меню", callback_data="nav_main")],
            ]
        ),
    )
...
async def adm_select_lesson_by_date(callback: CallbackQuery):
    ...
    await callback.message.edit_text(
        text,
        reply_markup=get_lesson_edit_keyboard(week_type, day_ru, idx),
        parse_mode=ParseMode.HTML,
    )
    await callback.answer()
...
async def admin_select_day(callback: CallbackQuery):
    ...
    keyboard.append([InlineKeyboardButton(text="❌ Удалить все пары этого дня", callback_data=f"adm_delday_{date_str}")])

    if date_str in temporary_changes:
        keyboard.append([InlineKeyboardButton(text="🔄 Сбросить все изменения дня", callback_data=f"adm_reset_{date_str}")])
